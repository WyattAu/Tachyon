...
// ============================================================================
// IPC integration tests — gated on desktop-tests feature
// ============================================================================
// These tests exercise Tauri IPC serialization contracts. The Tauri runtime
// is not available in CI, so they are gated behind the "desktop-tests"
// feature flag. Run with: cargo test --features desktop-tests
