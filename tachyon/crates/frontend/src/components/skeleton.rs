    ...
    view! {
        <div class="space-y-2 animate-pulse">
            {(0..lines).map(|i| {
                ...
                view! {
                    <div class={format!("h-4 bg-gray-200 dark:bg-gray-700 rounded {}", width)}></div>
                }
            }).collect::<Vec<_>>()}
        </div>
    }
...
pub fn SkeletonEditor() -> impl IntoView {
    view! {
        <div class="flex flex-col h-full animate-pulse">
            <div class="h-10 bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center px-4 gap-3">
                <div class="h-5 bg-gray-200 dark:bg-gray-700 rounded w-40"></div>
                <div class="h-5 bg-gray-200 dark:bg-gray-700 rounded w-6"></div>
            </div>
            ...
            <div class="h-8 bg-gray-100 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between px-4">
