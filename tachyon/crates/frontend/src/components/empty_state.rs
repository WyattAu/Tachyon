...
pub fn EmptyDocuments() -> impl IntoView {
    view! {
        <div class="bg-white dark:bg-gray-800 rounded-none border-2 border-gray-900 dark:border-gray-100 p-12 text-center">
            <svg class="mx-auto h-16 w-16 text-gray-300 dark:text-gray-600 mb-4" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">"No documents yet"</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">"Create your first document to get started."</p>
            <button
                class="px-4 py-2 bg-blue-600 text-white rounded-none border-2 border-blue-800 hover:bg-blue-700 transition-spring text-sm font-bold shadow-[3px_3px_0px_0px_rgba(0,0,0,0.15)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,0.15)] hover:-translate-x-[1px] hover:-translate-y-[1px]"
                on:click=move |_| {
...
pub fn EmptyNotifications() -> impl IntoView {
    view! {
        <div class="bg-white dark:bg-gray-800 rounded-none border-2 border-gray-900 dark:border-gray-100 p-12 text-center">
            ...
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">"You're all caught up!"</h3>
