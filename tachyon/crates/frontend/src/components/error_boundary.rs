                ...
                <div class="min-h-[50vh] flex items-center justify-center p-8">
                    <div class="max-w-md w-full text-center">
                        ...
                        <div class="flex items-center justify-center gap-3">
                            <button
                                class="px-4 py-2 bg-blue-600 text-white rounded-none hover:bg-blue-700 transition-spring text-sm font-medium"
                                on:click=reload
                            >
                                "Retry"
                            </button>
                            <a
                                ...
                                class="px-4 py-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded-none hover:bg-gray-50 dark:hover:bg-gray-700 transition-spring text-sm font-medium inline-block"
                            >
                                "Report Bug"
                            </a>
                        </div>
